...
<div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    <div>
        <h1 class="section-title">Kategori Banner</h1>
        <p class="section-subtitle">Kelola kelompok banner untuk rotasi promosi.</p>
    </div>
...
<?php if (empty($categories)): ?>
    <div class="empty-state">
        ...
        <p class="empty-state-copy">Buat kategori baru untuk mulai menambahkan banner.</p>
    </div>
<?php else: ?>
